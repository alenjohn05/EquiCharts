...
export function getCandleOptions(locale: string) {
  return [
    { key: "candle_solid", text: i18n("candle_solid", locale), type:CandleType.CandleSolid },
    { key: "candle_stroke", text: i18n("candle_stroke", locale), type:CandleType.CandleStroke  },
    { key: "candle_up_stroke", text: i18n("candle_up_stroke", locale), type:CandleType.CandleUpStroke },
    { key: "candle_down_stroke", text: i18n("candle_down_stroke", locale), type:CandleType.CandleDownStroke },
    ...
    { key: "line_marks", text: i18n("line_marks", locale), type:CandleType.LineMark },
    { key: "step_line", text: i18n("step_line", locale), type:CandleType.StepLine },
    { key: "heikin_ashi", text: i18n("heikin_ashi", locale), type:CandleType.HeikinAshi },
    { key: "candle_high_low", text: i18n("candle_high_low", locale), type:CandleType.CandleHighLow }
  ];
}
interface IconProps {
  class?: string
