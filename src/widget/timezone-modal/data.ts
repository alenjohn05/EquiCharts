...
export function translateTimezone(timezone: string, locale: string): string {
  switch (timezone) {
    case 'Etc/UTC':
      return i18n('utc', locale);
    case 'Pacific/Honolulu':
      return i18n('honolulu', locale);
    case 'America/Juneau':
      return i18n('juneau', locale);
    case 'America/Los_Angeles':
      return i18n('los_angeles', locale);
    case 'America/Chicago':
      return i18n('chicago', locale);
    case 'America/Toronto':
      return i18n('toronto', locale);
    case 'America/Sao_Paulo':
      return i18n('sao_paulo', locale);
    case 'Europe/London':
      return i18n('london', locale);
    case 'Europe/Berlin':
      return i18n('berlin', locale);
    case 'Asia/Bahrain':
      return i18n('bahrain', locale);
    case 'Asia/Dubai':
      return i18n('dubai', locale);
    case 'Asia/Ashkhabad':
      return i18n('ashkhabad', locale);
    case 'Asia/Almaty':
      return i18n('almaty', locale);
    case 'Asia/Bangkok':
      return i18n('bangkok', locale);
    case 'Asia/Shanghai':
      return i18n('shanghai', locale);
    case 'Asia/Tokyo':
      return i18n('tokyo', locale);
    case 'Australia/Sydney':
      return i18n('sydney', locale);
    case 'Pacific/Norfolk':
      return i18n('norfolk', locale);
  }
  return timezone;
}
