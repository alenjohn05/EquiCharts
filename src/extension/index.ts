...
const overlays = [
  ...
  threeWaves, fiveWaves, eightWaves, anyWaves, abcd, xabcd, elliotTripleComboWaves, headAndShoulders, measure, crossLine, faltTopBottom,
  disJointChannel, arc, tradingPlan,fibonacciDiagonal
]
