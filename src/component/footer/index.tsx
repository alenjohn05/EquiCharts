...
const Footer: Component<FooterProps> = (props) => {
  ...
  return (
    <div class="equicharts-footer-container">
      <div class="equicharts-footer-container-start"></div>
      <div class="equicharts-footer-container-clock">
        {time().toLocaleTimeString()}
      </div>
      <Tooltip top_length={-37} text={i18n('Time Zone', props.locale)}>
        <div
          onClick={props.onTimezoneClick}
          class="equicharts-footer-container-timezone"
        >
          {props.timezone.text}
        </div>
      </Tooltip>
      <Tooltip top_length={-37} text={i18n('Move to a Date', props.locale)}>
        <div
          ...
          class="equicharts-footer-container-moveto"
        >
