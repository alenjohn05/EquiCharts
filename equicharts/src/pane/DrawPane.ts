...
export default abstract class DrawPane<C extends Axis = Axis> extends Pane {
  ...
  private readonly _options: PickPartial<
    DeepRequired<Omit<PaneOptions, 'id' | 'height'>>,
    'position'
  > = {
  ...
  getMainWidget(): DrawWidget<DrawPane<C>> {
    return this._mainWidget;
  }

  getYAxisWidget(): Nullable<YAxisWidget> {
  ...
  protected createYAxisWidget(_container: HTMLElement): Nullable<YAxisWidget> {
    return null;
  }
