...
export default class IndicatorLastVisibleValueView extends View<YAxis> {
  override drawImp(ctx: CanvasRenderingContext2D): void {
    ...
    if (lastValueMarkStyles.show) {
      ...
      const dataList = chartStore.getVisibleDataList();
      const alldataList = chartStore.getDataList();
